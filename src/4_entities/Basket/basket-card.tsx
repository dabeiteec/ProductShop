...
export const BasketCard: React.FC<{ 
  ...
  const calculateFinalPrice = () => (product.price * productQuantity).toFixed(2);
  ...
  return (
    <Card>
      <ProductInfo>
        <ProductImage src={product.imgPath} alt={product.name} />
        <ProductDetails>
          <ProductName>{product.name}</ProductName>
          <ProductPrice>
            ${product.price} <PriceUnit>/ lb</PriceUnit>
          </ProductPrice>
          <QuantityControl>
            <QuantityInput
              type="number"
